...
<div id="respond">
	...
	<h3><?php comment_form_title( __( 'Add your Comment', 'woothemes' ), __( 'Leave a Reply to %s', 'woothemes' ) ); ?></h3>
	...
	<?php else : //No registration required ?>
		...
		<?php if ( $user_ID ) : //If user is logged in ?>
			...
			<p class="loggedin"><?php _e( 'Logged in as', 'woothemes' ); ?> <a href="<?php echo get_option( 'siteurl' ); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(); ?>" title="<?php esc_attr_e( 'Log out of this account', 'woothemes' ); ?>"><?php _e( 'Logout', 'woothemes' ) ?> &raquo;</a></p>
